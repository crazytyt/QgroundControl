    ...
    uas(NULL)
{
    ...
    {
        valueEnabled(tr("altitudeAMSL"));
        valueEnabled(tr("altitudeAMSLFT"));
        valueEnabled(tr("altitudeWGS84"));
        valueEnabled(tr("altitudeRelative"));
        valueEnabled(tr("groundSpeed"));
        valueEnabled(tr("distToWaypoint"));
    }
